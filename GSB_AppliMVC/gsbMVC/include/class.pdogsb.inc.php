...
*/
	public function getInfosVisiteur($login, $mdp){
		$req = "select visiteur.id as id, visiteur.nom as nom, visiteur.prenom as prenom, visiteur.comptable as comp from visiteur 
...
*/	
	...
	public function getInfos($mois){
		...
		$req = "select visiteur.nom as nom, fichefrais.idVisiteur as idVisiteur
			from  fichefrais 
